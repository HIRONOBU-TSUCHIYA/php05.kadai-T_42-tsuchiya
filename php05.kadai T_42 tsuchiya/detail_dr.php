...
<body>
    ...
    <div class="form-container">
            <h2>データ更新フォーム</h2>
                ...
                <div class="form-group">
                <label for="start_place">【積み地】</label>
                <input type="text" name="start_place" value="<?= $result['start_place'] ?>">
                </div>
                <div class="form-group">
                <label for="end_place">【降し地】</label>
                <input type="text" name="end_place" value="<?= $result['end_place'] ?>">
                </div>
                <div class="form-group">
                <label for="item">【品名】</label>
                <input type="item" name="item" value="<?= $result['item'] ?>">
                </div>
                <!-- <div class="form-group">
